...
typedef struct {
	...
	/* not process audio decoding */
	gboolean is_audio_excluded;
...
int _mmplayer_set_exclude_audio(MMHandleType hplayer , bool enable);
int _mmplayer_get_exclude_audio(MMHandleType hplayer, bool* no_audio);
