...
typedef enum
{
	MM_PLAYER_PRELISTENING_MODE_RINGTONE = 0,
	MM_PLAYER_PRELISTENING_MODE_NOTIFICATION,
	MM_PLAYER_PRELISTENING_MODE_ALARM,
	MM_PLAYER_PRELISTENING_MODE_MEDIA,
} MMPlayerPrelisteningMode;
